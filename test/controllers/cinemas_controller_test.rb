...
class CinemasControllerTest < ActionController::TestCase
  ...
  test "should create cinema" do
    assert_difference('Cinema.count') do
      post :create, cinema: { address: @cinema.address, latitude: @cinema.latitude, longitude: @cinema.longitude }
    end
  ...
  test "should update cinema" do
    patch :update, id: @cinema, cinema: { address: @cinema.address, latitude: @cinema.latitude, longitude: @cinema.longitude }
    assert_redirected_to cinema_path(assigns(:cinema))
  end
