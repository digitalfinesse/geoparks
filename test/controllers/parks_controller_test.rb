...
class ParksControllerTest < ActionController::TestCase
  ...
  test "should create park" do
    assert_difference('Park.count') do
      post :create, park: { address: @park.address, latitude: @park.latitude, longitude: @park.longitude }
    end
  ...
  test "should update park" do
    patch :update, id: @park, park: { address: @park.address, latitude: @park.latitude, longitude: @park.longitude }
    assert_redirected_to park_path(assigns(:park))
  end
